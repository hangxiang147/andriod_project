...
public class WeiMiMessage extends MessageContent {
    ...
    public static WeiMiMessage obtain(String text) {
        WeiMiMessage model = new WeiMiMessage();
        model.setContent(text);
        return model;
    }

    public WeiMiMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public static final Creator<WeiMiMessage> CREATOR = new Creator<WeiMiMessage>() {

        @Override
        public WeiMiMessage createFromParcel(Parcel source) {
            return new WeiMiMessage(source);
        }

        @Override
        public WeiMiMessage[] newArray(int size) {
            return new WeiMiMessage[size];
        }
    };
     ...
     */
    public WeiMiMessage(String content) {
