package com.weimi.weimichat.capabilities.log;
...
public final class EBLog {
    ...
    public static int v(String tag, String msg) {
        return WeiMiChatPrintln(LogType.verbose.value(), tag, msg);
    }
    ...
    public static int d(String tag, String msg) {
        return WeiMiChatPrintln(LogType.debug.value(), tag, msg);
    }
    ...
    public static int i(String tag, String msg) {
        return WeiMiChatPrintln(LogType.info.value(), tag, msg);
    }
    ...
    public static int w(String tag, String msg) {
        return WeiMiChatPrintln(LogType.warn.value(), tag, msg);
    }
    ...
    public static int w(String tag, Throwable tr) {
        return WeiMiChatPrintln(LogType.warn.value(), tag, getStackTraceString(tr));
    }
    ...
    public static int e(String tag, String msg) {
        return WeiMiChatPrintln(LogType.error.value(), tag, msg);
    }
    ...
    private static int WeiMiChatPrintln(int priority, String tag, String msg) {
