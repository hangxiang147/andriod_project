package com.weimi.weimichat.provider;
...
@ProviderTag(messageContent = WeiMiMessage.class, showReadState = true)
public class WeiMiMessageProvider extends IContainerItemProvider.MessageProvider<WeiMiMessage>{
    ...
    public View newView(Context context, ViewGroup group) {
        ...
        WeiMiMessageProvider.ViewHolder holder = new WeiMiMessageProvider.ViewHolder();
    ...
    @Override
    public Spannable getContentSummary(WeiMiMessage data) {
        return null;
    }

    @Override
    public Spannable getContentSummary(Context context, WeiMiMessage data) {
        if (data == null)
            return null;
    ...
    @Override
    public void onItemClick(View view, int position, WeiMiMessage content, UIMessage message) {

    }

    @Override
    public void onItemLongClick(final View view, int position, final WeiMiMessage content, final UIMessage message) {

        WeiMiMessageProvider.ViewHolder holder = (WeiMiMessageProvider.ViewHolder) view.getTag();
        ...
        OptionsPopupDialog.newInstance(view.getContext(), items).setOptionsPopupDialogListener(new OptionsPopupDialog.OnOptionsItemClickedListener() {
            ...
            public void onOptionsItemClicked(int which) {
                if (which == 0) {
                    ...
                    clipboard.setText(((WeiMiMessage) content).getContent());
                } else if (which == 1) {
    ...
    @Override
    public void bindView(final View v, int position, final WeiMiMessage content, final UIMessage data) {
        WeiMiMessageProvider.ViewHolder holder = (WeiMiMessageProvider.ViewHolder) v.getTag();
